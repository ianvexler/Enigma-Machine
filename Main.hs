...
enigma3 = (SteckeredEnigma rotor1 rotor2 rotor3 reflectorB (0,0,25) [('L','L'),('V','I'),('F','S'),('U','E')])
...
main = do
    ...
    --print (encodeMessage "YZCSDCVUFVJAAEMVILWRVSQZFCBPJFVYHUUPHLAPJMTMFNLURRADJFCBRBXBCUSSXVYWAPQIRCUVVNODKELDMNNQHYFEFOZPBUIPWKPXIYPKQHMVOAVXFVDCKMZOULMTQNUFBVHFUSXYCYPWFKBYW" enigma3)
